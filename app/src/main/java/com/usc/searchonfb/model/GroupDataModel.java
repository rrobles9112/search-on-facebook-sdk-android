...
public class GroupDataModel implements MainPresenterContract.Model {
    ...
    @Inject
    public GroupDataModel(Retrofit mRetrofit){
        ...
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<SearchDataList>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Log.i(GroupDataModel.class.getSimpleName(),"Error in loadUserDetails");
                    }
