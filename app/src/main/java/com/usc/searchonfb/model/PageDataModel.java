...
public class PageDataModel implements MainPresenterContract.Model {
    ...
    @Inject
    public PageDataModel(Retrofit mRetrofit){
    ...
    public void loadUserDetails(String SearchQuery,int offset, String url){
        ...
        if(url==null){
            observable = mRetrofit.create(GetSearchService.class).getDataList(SearchQuery,"Page",offset);
        }else{
        ...
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<SearchDataList>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Log.i(PageDataModel.class.getSimpleName(),"Error in loadUserDetails");
                    }
