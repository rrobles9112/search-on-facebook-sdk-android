...
public class GroupFragmentPresenter implements MainPresenterContract.Presenter, MainPresenterContract.ModelCallBack{
    ...
    @Inject
    public GroupFragmentPresenter(GroupDataModel pDataModel) {
        model = pDataModel;
        model.onAttach(this);
    }
