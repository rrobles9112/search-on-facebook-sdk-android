...
public class PlaceFragmentPresenter implements MainPresenterContract.Presenter, MainPresenterContract.ModelCallBack{

    MainPresenterContract.View mMainView = null;

    PlaceDataModel model;


    @Inject
    public PlaceFragmentPresenter(PlaceDataModel pDataModel) {
        model = pDataModel;
        model.onAttach(this);
    }
