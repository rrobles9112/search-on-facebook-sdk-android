...
public class EventFragmentPresenter implements MainPresenterContract.Presenter, MainPresenterContract.ModelCallBack{
    ...
    @Inject
    public EventFragmentPresenter(EventDataModel pDataModel) {
        model = pDataModel;
        model.onAttach(this);
    }
